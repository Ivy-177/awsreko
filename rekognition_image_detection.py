...
def usage_demo():
    ...
    street_scene_file_name = "./media/beautiful.jpeg"
    celebrity_file_name = "./media/handsome.jpeg"
    one_girl_url = './media/beautiful.jpeg'
    three_girls_url = './media/handsome.jpeg'
